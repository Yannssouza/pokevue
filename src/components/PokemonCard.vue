<script setup>
const pokemon = defineProps(["sprite", "name", "xp", "weight", "type", "height"]);
</script>
...
<template>
  <div class="flex flex-col items-center justify-center">
    ...
    <div class="p-5 text-center">
      <h5 class="mb-2 border-b-2 pb-2 text-xl font-medium text-gray-900">
        {{ pokemon.name }}
      </h5>
      <div
      ...
      >
        <div class="mb-2 flex flex-row items-center justify-center">
          <h2 class="pr-2 font-medium text-gray-900">XP:</h2>
